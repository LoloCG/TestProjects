from PySide6.QtWidgets import QWidget, QApplication, QCheckBox, QHBoxLayout, QVBoxLayout, QListWidget, QAbstractItemView, QPushButton,QButtonGroup
import sys

    # QListWidget allows creation of a list
